...
public class GoodsInfo {
    ...
    private static int[] mThumbArray = {
            R.drawable.lego1_s, R.drawable.lego2_s, R.drawable.lego3_s, R.drawable.lego4_s,
            R.drawable.lego5_s, R.drawable.lego6_s, R.drawable.lego7_s, R.drawable.lego9_s
    };
    // 声明一个商品的大图数组
    private static int[] mPicArray = {
            R.drawable.lego1, R.drawable.lego2, R.drawable.lego3, R.drawable.lego4,
            R.drawable.lego5, R.drawable.lego6, R.drawable.lego7, R.drawable.lego8
    };
